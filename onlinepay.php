...
include('header.php');
$conn = Connect();
if(!isset($_SESSION['login_user2']) || !isset($_SESSION['booking'])){
...
<html>
  ...
  <head>
    <title> Online Payment | Paradise </title>
  </head>
...
<div class="container">
    <div class="row">
        <div class="jumbotron">
          <h1 class="text-centering">Online Payment</h1>
          <p class="text-centers">Enter your payment details below.</p>
        </div>
    </div>
    <div class="row">
